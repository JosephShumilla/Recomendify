...
class recommender:
    ...
    def get_recommendations(self) -> list:
        ...
        if self.target == 'failure':
            raise ValueError("Unable to read playlist. Check that the URL is correct and that the playlist is accessible with the provided credentials.")
        tracks_data = []
        ...
        data_path = Path(__file__).resolve().parent / "data" / "small_data.csv"
        simTracks = dataset.generate_similarity_matrix(str(data_path), tracks_data)
